...
const ( // enum liinfitem
    ...
    LIINF_MIO_INTPNT_ITER int32 = 7
    LIINF_MIO_PRESOLVED_ANZ int32 = 8
    LIINF_MIO_SIM_MAXITER_SETBACKS int32 = 9
...
const ( // enum iparam
    ...
    IPAR_INTPNT_PURIFY int32 = 25
    IPAR_INTPNT_REGULARIZATION_USE int32 = 26
    IPAR_INTPNT_SCALING int32 = 27
    IPAR_INTPNT_SOLVE_FORM int32 = 28
    IPAR_INTPNT_STARTING_POINT int32 = 29
    IPAR_LICENSE_DEBUG int32 = 30
    IPAR_LICENSE_PAUSE_TIME int32 = 31
    IPAR_LICENSE_SUPPRESS_EXPIRE_WRNS int32 = 32
    IPAR_LICENSE_TRH_EXPIRY_WRN int32 = 33
    IPAR_LICENSE_WAIT int32 = 34
    IPAR_LOG int32 = 35
    IPAR_LOG_ANA_PRO int32 = 36
    IPAR_LOG_BI int32 = 37
    IPAR_LOG_BI_FREQ int32 = 38
    IPAR_LOG_CHECK_CONVEXITY int32 = 39
    IPAR_LOG_CUT_SECOND_OPT int32 = 40
    IPAR_LOG_EXPAND int32 = 41
    IPAR_LOG_FEAS_REPAIR int32 = 42
    IPAR_LOG_FILE int32 = 43
    IPAR_LOG_INFEAS_ANA int32 = 44
    IPAR_LOG_INTPNT int32 = 45
    IPAR_LOG_MIO int32 = 46
    IPAR_LOG_MIO_FREQ int32 = 47
    IPAR_LOG_ORDER int32 = 48
    IPAR_LOG_PRESOLVE int32 = 49
    IPAR_LOG_RESPONSE int32 = 50
    IPAR_LOG_SENSITIVITY int32 = 51
    IPAR_LOG_SENSITIVITY_OPT int32 = 52
    IPAR_LOG_SIM int32 = 53
    IPAR_LOG_SIM_FREQ int32 = 54
    IPAR_LOG_SIM_MINOR int32 = 55
    IPAR_LOG_STORAGE int32 = 56
    IPAR_MAX_NUM_WARNINGS int32 = 57
    IPAR_MIO_BRANCH_DIR int32 = 58
    IPAR_MIO_CONSTRUCT_SOL int32 = 59
    IPAR_MIO_CUT_CLIQUE int32 = 60
    IPAR_MIO_CUT_CMIR int32 = 61
    IPAR_MIO_CUT_GMI int32 = 62
    IPAR_MIO_CUT_IMPLIED_BOUND int32 = 63
    IPAR_MIO_CUT_KNAPSACK_COVER int32 = 64
    IPAR_MIO_CUT_SELECTION_LEVEL int32 = 65
    IPAR_MIO_HEURISTIC_LEVEL int32 = 66
    IPAR_MIO_MAX_NUM_BRANCHES int32 = 67
    IPAR_MIO_MAX_NUM_RELAXS int32 = 68
    IPAR_MIO_MAX_NUM_SOLUTIONS int32 = 69
    IPAR_MIO_MODE int32 = 70
    IPAR_MIO_MT_USER_CB int32 = 71
    IPAR_MIO_NODE_OPTIMIZER int32 = 72
    IPAR_MIO_NODE_SELECTION int32 = 73
    IPAR_MIO_PERSPECTIVE_REFORMULATE int32 = 74
    IPAR_MIO_PROBING_LEVEL int32 = 75
    IPAR_MIO_PROPAGATE_OBJECTIVE_CONSTRAINT int32 = 76
    IPAR_MIO_RINS_MAX_NODES int32 = 77
    IPAR_MIO_ROOT_OPTIMIZER int32 = 78
    IPAR_MIO_ROOT_REPEAT_PRESOLVE_LEVEL int32 = 79
    IPAR_MIO_SEED int32 = 80
    ...
    IPAR_READ_DEBUG int32 = 105
    IPAR_READ_KEEP_FREE_CON int32 = 106
    IPAR_READ_LP_DROP_NEW_VARS_IN_BOU int32 = 107
    IPAR_READ_LP_QUOTED_NAMES int32 = 108
    IPAR_READ_MPS_FORMAT int32 = 109
    IPAR_READ_MPS_WIDTH int32 = 110
    IPAR_READ_TASK_IGNORE_PARAM int32 = 111
    IPAR_REMOVE_UNUSED_SOLUTIONS int32 = 112
    IPAR_SENSITIVITY_ALL int32 = 113
    IPAR_SENSITIVITY_OPTIMIZER int32 = 114
    IPAR_SENSITIVITY_TYPE int32 = 115
    IPAR_SIM_BASIS_FACTOR_USE int32 = 116
    IPAR_SIM_DEGEN int32 = 117
    IPAR_SIM_DUAL_CRASH int32 = 118
    IPAR_SIM_DUAL_PHASEONE_METHOD int32 = 119
    IPAR_SIM_DUAL_RESTRICT_SELECTION int32 = 120
    IPAR_SIM_DUAL_SELECTION int32 = 121
    IPAR_SIM_EXPLOIT_DUPVEC int32 = 122
    IPAR_SIM_HOTSTART int32 = 123
    IPAR_SIM_HOTSTART_LU int32 = 124
    IPAR_SIM_MAX_ITERATIONS int32 = 125
    IPAR_SIM_MAX_NUM_SETBACKS int32 = 126
    IPAR_SIM_NON_SINGULAR int32 = 127
    IPAR_SIM_PRIMAL_CRASH int32 = 128
    IPAR_SIM_PRIMAL_PHASEONE_METHOD int32 = 129
    IPAR_SIM_PRIMAL_RESTRICT_SELECTION int32 = 130
    IPAR_SIM_PRIMAL_SELECTION int32 = 131
    IPAR_SIM_REFACTOR_FREQ int32 = 132
    IPAR_SIM_REFORMULATION int32 = 133
    IPAR_SIM_SAVE_LU int32 = 134
    IPAR_SIM_SCALING int32 = 135
    IPAR_SIM_SCALING_METHOD int32 = 136
    IPAR_SIM_SOLVE_FORM int32 = 137
    IPAR_SIM_STABILITY_PRIORITY int32 = 138
    IPAR_SIM_SWITCH_OPTIMIZER int32 = 139
    IPAR_SOL_FILTER_KEEP_BASIC int32 = 140
    IPAR_SOL_FILTER_KEEP_RANGED int32 = 141
    IPAR_SOL_READ_NAME_WIDTH int32 = 142
    IPAR_SOL_READ_WIDTH int32 = 143
    IPAR_SOLUTION_CALLBACK int32 = 144
    IPAR_TIMING_LEVEL int32 = 145
    IPAR_WRITE_BAS_CONSTRAINTS int32 = 146
    IPAR_WRITE_BAS_HEAD int32 = 147
    IPAR_WRITE_BAS_VARIABLES int32 = 148
    IPAR_WRITE_COMPRESSION int32 = 149
    IPAR_WRITE_DATA_PARAM int32 = 150
    IPAR_WRITE_FREE_CON int32 = 151
    IPAR_WRITE_GENERIC_NAMES int32 = 152
    IPAR_WRITE_GENERIC_NAMES_IO int32 = 153
    IPAR_WRITE_IGNORE_INCOMPATIBLE_ITEMS int32 = 154
    IPAR_WRITE_INT_CONSTRAINTS int32 = 155
    IPAR_WRITE_INT_HEAD int32 = 156
    IPAR_WRITE_INT_VARIABLES int32 = 157
    IPAR_WRITE_LP_FULL_OBJ int32 = 158
    IPAR_WRITE_LP_LINE_WIDTH int32 = 159
    IPAR_WRITE_LP_QUOTED_NAMES int32 = 160
    IPAR_WRITE_LP_STRICT_FORMAT int32 = 161
    IPAR_WRITE_LP_TERMS_PER_LINE int32 = 162
    IPAR_WRITE_MPS_FORMAT int32 = 163
    IPAR_WRITE_MPS_INT int32 = 164
    IPAR_WRITE_PRECISION int32 = 165
    IPAR_WRITE_SOL_BARVARIABLES int32 = 166
    IPAR_WRITE_SOL_CONSTRAINTS int32 = 167
    IPAR_WRITE_SOL_HEAD int32 = 168
    IPAR_WRITE_SOL_IGNORE_INVALID_NAMES int32 = 169
    IPAR_WRITE_SOL_VARIABLES int32 = 170
    IPAR_WRITE_TASK_INC_SOL int32 = 171
    IPAR_WRITE_XML_MODE int32 = 172
    IPAR_BEGIN int32 = 0
    IPAR_END   int32 = 173
)
...
const ( // enum iinfitem
    ...
    IINF_PURIFY_DUAL_SUCCESS int32 = 52
    IINF_PURIFY_PRIMAL_SUCCESS int32 = 53
    IINF_RD_NUMBARVAR int32 = 54
    IINF_RD_NUMCON int32 = 55
    IINF_RD_NUMCONE int32 = 56
    IINF_RD_NUMINTVAR int32 = 57
    IINF_RD_NUMQ int32 = 58
    IINF_RD_NUMVAR int32 = 59
    IINF_RD_PROTYPE int32 = 60
    IINF_SIM_DUAL_DEG_ITER int32 = 61
    IINF_SIM_DUAL_HOTSTART int32 = 62
    IINF_SIM_DUAL_HOTSTART_LU int32 = 63
    IINF_SIM_DUAL_INF_ITER int32 = 64
    IINF_SIM_DUAL_ITER int32 = 65
    IINF_SIM_NUMCON int32 = 66
    IINF_SIM_NUMVAR int32 = 67
    IINF_SIM_PRIMAL_DEG_ITER int32 = 68
    IINF_SIM_PRIMAL_HOTSTART int32 = 69
    IINF_SIM_PRIMAL_HOTSTART_LU int32 = 70
    IINF_SIM_PRIMAL_INF_ITER int32 = 71
    IINF_SIM_PRIMAL_ITER int32 = 72
    IINF_SIM_SOLVE_DUAL int32 = 73
    IINF_SOL_BAS_PROSTA int32 = 74
    IINF_SOL_BAS_SOLSTA int32 = 75
    IINF_SOL_ITG_PROSTA int32 = 76
    IINF_SOL_ITG_SOLSTA int32 = 77
    IINF_SOL_ITR_PROSTA int32 = 78
    IINF_SOL_ITR_SOLSTA int32 = 79
    IINF_STO_NUM_A_REALLOC int32 = 80
    IINF_BEGIN int32 = 0
    IINF_END   int32 = 81
)
const ( // enum solitem
...
const ( // enum solsta
    ...
    SOL_STA_DUAL_ILLPOSED_CER int32 = 14
    SOL_STA_DUAL_INFEAS_CER int32 = 6
    SOL_STA_INTEGER_OPTIMAL int32 = 15
    SOL_STA_NEAR_DUAL_FEAS int32 = 9
    SOL_STA_NEAR_DUAL_INFEAS_CER int32 = 12
    SOL_STA_NEAR_INTEGER_OPTIMAL int32 = 16
    SOL_STA_NEAR_OPTIMAL int32 = 7
    SOL_STA_NEAR_PRIM_AND_DUAL_FEAS int32 = 10
    SOL_STA_NEAR_PRIM_FEAS int32 = 8
    SOL_STA_NEAR_PRIM_INFEAS_CER int32 = 11
    SOL_STA_OPTIMAL int32 = 1
    SOL_STA_PRIM_AND_DUAL_FEAS int32 = 4
    SOL_STA_PRIM_FEAS int32 = 2
    SOL_STA_PRIM_ILLPOSED_CER int32 = 13
    SOL_STA_PRIM_INFEAS_CER int32 = 5
    SOL_STA_UNKNOWN int32 = 0
    SOL_STA_BEGIN int32 = 0
    SOL_STA_END   int32 = 17
)
const ( // enum onoffkey
    OFF int32 = 0
    ON int32 = 1
...
const ( // enum dparam
    ...
    DPAR_MIO_DISABLE_TERM_TIME int32 = 40
    DPAR_MIO_MAX_TIME int32 = 41
    DPAR_MIO_NEAR_TOL_ABS_GAP int32 = 42
    DPAR_MIO_NEAR_TOL_REL_GAP int32 = 43
    DPAR_MIO_REL_GAP_CONST int32 = 44
    DPAR_MIO_TOL_ABS_GAP int32 = 45
    DPAR_MIO_TOL_ABS_RELAX_INT int32 = 46
    DPAR_MIO_TOL_FEAS int32 = 47
    DPAR_MIO_TOL_REL_DUAL_BOUND_IMPROVEMENT int32 = 48
    DPAR_MIO_TOL_REL_GAP int32 = 49
    DPAR_OPTIMIZER_MAX_TIME int32 = 50
    DPAR_PRESOLVE_TOL_ABS_LINDEP int32 = 51
    DPAR_PRESOLVE_TOL_AIJ int32 = 52
    DPAR_PRESOLVE_TOL_REL_LINDEP int32 = 53
    DPAR_PRESOLVE_TOL_S int32 = 54
    DPAR_PRESOLVE_TOL_X int32 = 55
    DPAR_QCQO_REFORMULATE_REL_DROP_TOL int32 = 56
    DPAR_SEMIDEFINITE_TOL_APPROX int32 = 57
    DPAR_SIM_LU_TOL_REL_PIV int32 = 58
    DPAR_SIMPLEX_ABS_TOL_PIV int32 = 59
    DPAR_UPPER_OBJ_CUT int32 = 60
    DPAR_UPPER_OBJ_CUT_FINITE_TRH int32 = 61
    DPAR_BEGIN int32 = 0
    DPAR_END   int32 = 62
)
...
const ( // enum dinfitem
    ...
    DINF_MIO_HEURISTIC_TIME int32 = 19
    DINF_MIO_IMPLIED_BOUND_TIME int32 = 20
    DINF_MIO_KNAPSACK_COVER_SEPARATION_TIME int32 = 21
    DINF_MIO_OBJ_ABS_GAP int32 = 22
    DINF_MIO_OBJ_BOUND int32 = 23
    DINF_MIO_OBJ_INT int32 = 24
    DINF_MIO_OBJ_REL_GAP int32 = 25
    DINF_MIO_OPTIMIZER_TIME int32 = 26
    DINF_MIO_PROBING_TIME int32 = 27
    DINF_MIO_ROOT_CUTGEN_TIME int32 = 28
    DINF_MIO_ROOT_OPTIMIZER_TIME int32 = 29
    DINF_MIO_ROOT_PRESOLVE_TIME int32 = 30
    DINF_MIO_TIME int32 = 31
    DINF_MIO_USER_OBJ_CUT int32 = 32
    DINF_OPTIMIZER_TIME int32 = 33
    DINF_PRESOLVE_ELI_TIME int32 = 34
    DINF_PRESOLVE_LINDEP_TIME int32 = 35
    DINF_PRESOLVE_TIME int32 = 36
    DINF_PRIMAL_REPAIR_PENALTY_OBJ int32 = 37
    DINF_QCQO_REFORMULATE_MAX_PERTURBATION int32 = 38
    DINF_QCQO_REFORMULATE_TIME int32 = 39
    DINF_QCQO_REFORMULATE_WORST_CHOLESKY_COLUMN_SCALING int32 = 40
    DINF_QCQO_REFORMULATE_WORST_CHOLESKY_DIAG_SCALING int32 = 41
    DINF_RD_TIME int32 = 42
    DINF_SIM_DUAL_TIME int32 = 43
    DINF_SIM_FEAS int32 = 44
    DINF_SIM_OBJ int32 = 45
    DINF_SIM_PRIMAL_TIME int32 = 46
    DINF_SIM_TIME int32 = 47
    DINF_SOL_BAS_DUAL_OBJ int32 = 48
    DINF_SOL_BAS_DVIOLCON int32 = 49
    DINF_SOL_BAS_DVIOLVAR int32 = 50
    DINF_SOL_BAS_NRM_BARX int32 = 51
    DINF_SOL_BAS_NRM_SLC int32 = 52
    DINF_SOL_BAS_NRM_SLX int32 = 53
    DINF_SOL_BAS_NRM_SUC int32 = 54
    DINF_SOL_BAS_NRM_SUX int32 = 55
    DINF_SOL_BAS_NRM_XC int32 = 56
    DINF_SOL_BAS_NRM_XX int32 = 57
    DINF_SOL_BAS_NRM_Y int32 = 58
    DINF_SOL_BAS_PRIMAL_OBJ int32 = 59
    DINF_SOL_BAS_PVIOLCON int32 = 60
    DINF_SOL_BAS_PVIOLVAR int32 = 61
    DINF_SOL_ITG_NRM_BARX int32 = 62
    DINF_SOL_ITG_NRM_XC int32 = 63
    DINF_SOL_ITG_NRM_XX int32 = 64
    DINF_SOL_ITG_PRIMAL_OBJ int32 = 65
    DINF_SOL_ITG_PVIOLBARVAR int32 = 66
    DINF_SOL_ITG_PVIOLCON int32 = 67
    DINF_SOL_ITG_PVIOLCONES int32 = 68
    DINF_SOL_ITG_PVIOLITG int32 = 69
    DINF_SOL_ITG_PVIOLVAR int32 = 70
    DINF_SOL_ITR_DUAL_OBJ int32 = 71
    DINF_SOL_ITR_DVIOLBARVAR int32 = 72
    DINF_SOL_ITR_DVIOLCON int32 = 73
    DINF_SOL_ITR_DVIOLCONES int32 = 74
    DINF_SOL_ITR_DVIOLVAR int32 = 75
    DINF_SOL_ITR_NRM_BARS int32 = 76
    DINF_SOL_ITR_NRM_BARX int32 = 77
    DINF_SOL_ITR_NRM_SLC int32 = 78
    DINF_SOL_ITR_NRM_SLX int32 = 79
    DINF_SOL_ITR_NRM_SNX int32 = 80
    DINF_SOL_ITR_NRM_SUC int32 = 81
    DINF_SOL_ITR_NRM_SUX int32 = 82
    DINF_SOL_ITR_NRM_XC int32 = 83
    DINF_SOL_ITR_NRM_XX int32 = 84
    DINF_SOL_ITR_NRM_Y int32 = 85
    DINF_SOL_ITR_PRIMAL_OBJ int32 = 86
    DINF_SOL_ITR_PVIOLBARVAR int32 = 87
    DINF_SOL_ITR_PVIOLCON int32 = 88
    DINF_SOL_ITR_PVIOLCONES int32 = 89
    DINF_SOL_ITR_PVIOLVAR int32 = 90
    DINF_TO_CONIC_TIME int32 = 91
    DINF_BEGIN int32 = 0
    DINF_END   int32 = 92
)
const ( // enum scopr
...
func (task *Task) PutARowList(sub_ []int32,ptrb_ []int32,ptre_ []int32,asub_ []int32,aval_ []float64) () {
  if task.r == RES_OK {
    num_ := minint([]int{ len(sub_),len(ptrb_),len(ptre_) })
    _c_num_ := C.MSKint32t(num_)
    ...
    var _c_aval_ *C.MSKrealt = nil
    if len(aval_) > 0 { _c_aval_ = (*C.MSKrealt)(&aval_[0]) }
    task.r = int32(C.MSK_putarowlist(task.ptr(),_c_num_,_c_sub_,_c_ptrb_,_c_ptre_,_c_asub_,_c_aval_))
    if task.r != 0 { return }
  }
  return
}
...
func (task *Task) PutConBoundList(sub_ []int32,bk_ []int32,bl_ []float64,bu_ []float64) () {
  if task.r == RES_OK {
    ...
    var _c_sub_ *C.MSKint32t = nil
    if len(sub_) > 0 { _c_sub_ = (*C.MSKint32t)(&sub_[0]) }
    if bk_ == nil { panic("Argument 'bk_' is nil in call to 'PutConBoundList'") }
    var _c_bk_ *C.MSKboundkeye = nil
    if len(bk_) > 0 { _c_bk_ = (*C.MSKboundkeye)(unsafe.Pointer(&bk_[0])) }
    if bl_ == nil { panic("Argument 'bl_' is nil in call to 'PutConBoundList'") }
    var _c_bl_ *C.MSKrealt = nil
    if len(bl_) > 0 { _c_bl_ = (*C.MSKrealt)(&bl_[0]) }
    if bu_ == nil { panic("Argument 'bu_' is nil in call to 'PutConBoundList'") }
    var _c_bu_ *C.MSKrealt = nil
    if len(bu_) > 0 { _c_bu_ = (*C.MSKrealt)(&bu_[0]) }
    task.r = int32(C.MSK_putconboundlist(task.ptr(),_c_num_,_c_sub_,_c_bk_,_c_bl_,_c_bu_))
    if task.r != 0 { return }
  }
  return
}
...
func (task *Task) Sctoconic(opro_ []int32,oprjo_ []int32,oprfo_ []float64,oprgo_ []float64,oprho_ []float64,oprc_ []int32,opric_ []int32,oprjc_ []int32,oprfc_ []float64,oprgc_ []float64,oprhc_ []float64) () {
  if task.r == RES_OK {
    numopro_ := minint([]int{ len(opro_),len(oprjo_),len(oprfo_),len(oprgo_),len(oprho_) })
    _c_numopro_ := C.MSKint32t(numopro_)
    if opro_ == nil { panic("Argument 'opro_' is nil in call to 'Sctoconic'") }
    var _c_opro_ *C.MSKscopre = nil
    if len(opro_) > 0 { _c_opro_ = (*C.MSKscopre)(unsafe.Pointer(&opro_[0])) }
    if oprjo_ == nil { panic("Argument 'oprjo_' is nil in call to 'Sctoconic'") }
    var _c_oprjo_ *C.MSKint32t = nil
    if len(oprjo_) > 0 { _c_oprjo_ = (*C.MSKint32t)(&oprjo_[0]) }
    if oprfo_ == nil { panic("Argument 'oprfo_' is nil in call to 'Sctoconic'") }
    var _c_oprfo_ *C.MSKrealt = nil
    if len(oprfo_) > 0 { _c_oprfo_ = (*C.MSKrealt)(&oprfo_[0]) }
    if oprgo_ == nil { panic("Argument 'oprgo_' is nil in call to 'Sctoconic'") }
    var _c_oprgo_ *C.MSKrealt = nil
    if len(oprgo_) > 0 { _c_oprgo_ = (*C.MSKrealt)(&oprgo_[0]) }
    if oprho_ == nil { panic("Argument 'oprho_' is nil in call to 'Sctoconic'") }
    var _c_oprho_ *C.MSKrealt = nil
    if len(oprho_) > 0 { _c_oprho_ = (*C.MSKrealt)(&oprho_[0]) }
    numoprc_ := minint([]int{ len(oprc_),len(opric_),len(oprjc_),len(oprfc_),len(oprgc_),len(oprhc_) })
    _c_numoprc_ := C.MSKint32t(numoprc_)
    if oprc_ == nil { panic("Argument 'oprc_' is nil in call to 'Sctoconic'") }
    var _c_oprc_ *C.MSKscopre = nil
    if len(oprc_) > 0 { _c_oprc_ = (*C.MSKscopre)(unsafe.Pointer(&oprc_[0])) }
    if opric_ == nil { panic("Argument 'opric_' is nil in call to 'Sctoconic'") }
    var _c_opric_ *C.MSKint32t = nil
    if len(opric_) > 0 { _c_opric_ = (*C.MSKint32t)(&opric_[0]) }
    if oprjc_ == nil { panic("Argument 'oprjc_' is nil in call to 'Sctoconic'") }
    var _c_oprjc_ *C.MSKint32t = nil
    if len(oprjc_) > 0 { _c_oprjc_ = (*C.MSKint32t)(&oprjc_[0]) }
    if oprfc_ == nil { panic("Argument 'oprfc_' is nil in call to 'Sctoconic'") }
    var _c_oprfc_ *C.MSKrealt = nil
    if len(oprfc_) > 0 { _c_oprfc_ = (*C.MSKrealt)(&oprfc_[0]) }
    if oprgc_ == nil { panic("Argument 'oprgc_' is nil in call to 'Sctoconic'") }
    var _c_oprgc_ *C.MSKrealt = nil
    if len(oprgc_) > 0 { _c_oprgc_ = (*C.MSKrealt)(&oprgc_[0]) }
    if oprhc_ == nil { panic("Argument 'oprhc_' is nil in call to 'Sctoconic'") }
    var _c_oprhc_ *C.MSKrealt = nil
    if len(oprhc_) > 0 { _c_oprhc_ = (*C.MSKrealt)(&oprhc_[0]) }
    task.r = int32(C.MSK_sctoconic(task.ptr(),_c_numopro_,_c_opro_,_c_oprjo_,_c_oprfo_,_c_oprgo_,_c_oprho_,_c_numoprc_,_c_oprc_,_c_opric_,_c_oprjc_,_c_oprfc_,_c_oprgc_,_c_oprhc_))
    if task.r != 0 { return }
  }
  return
}
